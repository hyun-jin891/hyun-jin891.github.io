...
* Sketch
![그림1](/assets/img/50.PNG?raw=true){: width="600" height="600"}<br>
![그림2](/assets/img/51.PNG?raw=true){: width="600" height="600"}<br>
...
![그림3](/assets/img/52.PNG?raw=true){: width="600" height="600"}<br>
...
![그림4](/assets/img/53.PNG?raw=true){: width="600" height="600"}<br>
...
![그림5](/assets/img/54.PNG?raw=true){: width="600" height="600"}<br>
should find **maximum** KOI length<br>
